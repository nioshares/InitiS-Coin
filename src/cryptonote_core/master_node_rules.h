...
namespace master_nodes {
  ...
  constexpr size_t   MIN_VOTES_TO_KICK_MASTER_NODE   = 7;
...
// return: UINT64_MAX if (num_contributions > the max number of contributions), otherwise the amount in initi atomic units
