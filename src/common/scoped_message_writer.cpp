...
#define INITIS_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/initis_integration_test_hooks.h"

// NOTE(initi): This file only exists because I need a way to hook into the
...
// initis_integration_test_hooks.h functions which isn't possible to expose in
